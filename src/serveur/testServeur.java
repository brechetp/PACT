...
public class testServeur 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		try {
			...
			Thread.sleep(100);
			serveur.envoiCarteDistribution(ValTr);
			Thread.sleep(100);
			serveur.envoiCarteDistribution(ValCo);
			Thread.sleep(100);
			serveur.envoiCarteDistribution(NeuCo);
			Thread.sleep(100);
			serveur.envoiCarteDistribution(DixCo);
			Thread.sleep(100);
			...
			Thread.sleep(2000);
			serveur.envoiAnnonce(new Annonce("trefle", 90, 1), 2);
			Thread.sleep(2000);
			serveur.envoiAnnonce(new Annonce("carreau", 100, 1), 3);
			Thread.sleep(1000);
			...
			Thread.sleep(100);
			serveur.envoiCarte(HuiCo, 1);
			Thread.sleep(100);
			serveur.envoiCarte(RenCo, 2);
			Thread.sleep(100);
			serveur.envoiCarte(RoiCo, 3);
