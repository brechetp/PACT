	...
	public void paintComponent(Graphics g){
		...
		try {
		    ...
		    if (modeActuel == 777){
		    	...
		    	g.drawString("Insérer le texte descriptif et la photo ici", (this.getWidth()/2)-(metrics.stringWidth("Ins�rer le texte descriptif et la photo ici")/2) , (int) ((this.getHeight())*0.6));
