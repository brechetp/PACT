...
public class MyListener extends Listener{
	...
	private int y = 0; // parametre de v�rification de conditions
...
/*    	
    	...
    	if (k1.getC()=='p'){
    		...
    		try{
        		...
        		System.out.println("Nombre de donn�es : " + compteurMain + " ||| Nombre de >3 doigts : " + compteur2Main + " ||| " + pourcentage + "% de >3 doigts");
    		}
    		catch(Exception i)
    		{
    			i.printStackTrace();
